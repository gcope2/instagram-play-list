...
`,Re=[Se,ke,Se,...ze,$e,Ue,je,Ce,_e,Te,Le,Ee,Me,Ie,Ne,Pe,Ae,Oe];class De extends se{constructor(){super(),this.active=null,this.systems=[]}static get tag(){return"design-system"}static get properties(){return{active:{type:String},systems:{type:Object}}}updated(e){super.updated&&super.updated(e),e.forEach((e,t)=>{"active"===t&&this[t]&&this.systems[this.active]&&globalThis.document&&globalThis.document.head&&this.applyDesignSystem(e?this.systems[e]:null,this.systems[this.active])})}addDesignSystem(e){e.name&&e.styles&&e.fonts&&(this.systems[e.name]=e)}applyDesignSystem(e,t){if(e){try{globalThis.document.adoptedStyleSheets&&globalThis.document.adoptedStyleSheets.map((e,t)=>{e.ds&&globalThis.document.adoptedStyleSheets.splice(t,1)})}catch(e){const t=globalThis.document.createElement("style");t.innerHTML=globalStyles,globalThis.document.head.appendChild(t)}e.fonts&&globalThis.document.head.querySelectorAll("[data-ds]").forEach(e=>{e.remove()}),e.onload&&(globalThis.document.onload=null)}if(t){let e=t.styles.map(e=>e.cssText?e.cssText:"").join("");try{const a=new CSSStyleSheet;a.ds=!0,a.replaceSync(e),t.hax&&(a.hax=!0),globalThis.document.adoptedStyleSheets=[...globalThis.document.adoptedStyleSheets,a]}catch(t){const a=globalThis.document.createElement("style");a.innerHTML=e,globalThis.document.head.appendChild(a)}t.fonts&&t.fonts.forEach(e=>{const t=globalThis.document.createElement("link");t.setAttribute("href",e),t.setAttribute("rel","stylesheet"),t.setAttribute("fetchpriority","low"),t.setAttribute("data-ds","font"),globalThis.document.head.appendChild(t)}),t.onload&&(globalThis.document.onload=t.onload())}}}globalThis.customElements.define(De.tag,De),globalThis.DesignSystemManager=globalThis.DesignSystemManager||{},globalThis.DesignSystemManager.requestAvailability=()=>{if(!globalThis.DesignSystemManager.instance&&globalThis.document&&globalThis.document.body){let e=globalThis.document.createElement("design-system");globalThis.document.body.appendChild(e),globalThis.DesignSystemManager.instance=e}return globalThis.DesignSystemManager.instance};const Be=globalThis.DesignSystemManager.requestAvailability(),He=function(e){return class extends e{constructor(){super(),this.isSafari=void 0!==globalThis.safari,Be.systems.ddd||(Be.addDesignSystem({name:"ddd",styles:Re,fonts:we,onload:()=>{CSS.supports("initial-letter","1")||(console.warn("CSS feature: initial-letter not supported"),console.warn("Adding dropCap-noSupport class"),globalThis.document.body.classList.add("dropCap-noSupport"))},hax:!0}),Be.active="ddd")}static get properties(){return{...super.properties,isSafari:{type:Boolean,reflect:!0,attribute:"is-safari"}}}static get styles(){let e=[];return super.styles&&(e=super.styles),[e,$e]}}};class qe extends(He(me(se))){constructor(){super()}static get tag(){return"d-d-d"}}globalThis.customElements.define(qe.tag,qe);class Fe extends(He(se)){constructor(){super(),this.type=null,this.option=0}static get styles(){return[super.styles,...ze,o`
    ...
    `}}globalThis.customElements.define(Je.tag,Je);class Ze extends(He(Ve(se))){static get tag(){return"instagram-play-list-slide"}constructor(){super(),this.active=!1}static get properties(){return{...super.properties,active:{type:Boolean,reflect:!0}}}static get styles(){return[super.styles,o`
      :host([active]) {
        display: block;
      }
      :host(:not([active])) {
    ...
    `]}render(){return q`
      ...
      `}}globalThis.customElements.define(Ze.tag,Ze);class Qe extends(He(Ve(se))){static get tag(){return"instagram-play-list-dots"}constructor(){super(),this.total=0,this.curIndex=0,this.images=[]}static get properties(){return{...super.properties,total:{type:Number},curIndex:{type:Number},images:{type:Array}}}static get styles(){return[super.styles,o`
      :host {
        display: block;
      }
      .dots {
    ...
    `]}render(){let e=[];for(let t=0;t<this.total;t++){const a=this.images[t]||{},d=a.thumbnail||a.url||"";e.push(q`
        <img 
          @click="${this._handleDotClick}" 
          data-index="${t}" 
          class="thumbnail ${t===this.curIndex?"active":""}" 
          src="${d}" 
          alt="Thumbnail ${t+1}" 
          loading="lazy"
        />
    ...
    `]}render(){return q`
        ...
        <div class="slide-footer">
          ...
          <div class="post-collumn">
            ...
            <div>
              <p class="desc-text">${e.description||""}</p>
            </div>
          </div>
    ...
    `]}render(){return q`
      ...
      `}}globalThis.customElements.define(tt.tag,tt);
