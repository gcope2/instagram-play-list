const e=globalThis,t=e.ShadowRoot&&(void 0===e.ShadyCSS||e.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,a=Symbol(),d=new WeakMap;let r=class{constructor(e,t,d){if(this._$cssResult$=!0,d!==a)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const a=this.t;if(t&&void 0===e){const t=void 0!==a&&1===a.length;t&&(e=d.get(a)),void 0===e&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),t&&d.set(a,e))}return e}toString(){return this.cssText}};const i=e=>new r("string"==typeof e?e:e+"",void 0,a),o=(e,...t)=>{const d=1===e.length?e[0]:t.reduce((t,a,d)=>t+(e=>{if(!0===e._$cssResult$)return e.cssText;if("number"==typeof e)return e;throw Error("Value passed to 'css' function must be a 'css' function result: "+e+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(a)+e[d+1],e[0]);return new r(d,e,a)},s=t?e=>e:e=>e instanceof CSSStyleSheet?(e=>{let t="";for(const a of e.cssRules)t+=a.cssText;return i(t)})(e):e,{is:l,defineProperty:n,getOwnPropertyDescriptor:c,getOwnPropertyNames:m,getOwnPropertySymbols:p,getPrototypeOf:f}=Object,h=globalThis,g=h.trustedTypes,u=g?g.emptyScript:"",b=h.reactiveElementPolyfillSupport,v=(e,t)=>e,x={toAttribute(e,t){switch(t){case Boolean:e=e?u:null;break;case Object:case Array:e=null==e?e:JSON.stringify(e)}return e},fromAttribute(e,t){let a=e;switch(t){case Boolean:a=null!==e;break;case Number:a=null===e?null:Number(e);break;case Object:case Array:try{a=JSON.parse(e)}catch(e){a=null}}return a}},y=(e,t)=>!l(e,t),w={attribute:!0,type:String,converter:x,reflect:!1,useDefault:!1,hasChanged:y};Symbol.metadata??=Symbol("metadata"),h.litPropertyMetadata??=new WeakMap;let k=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=w){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){const a=Symbol(),d=this.getPropertyDescriptor(e,a,t);void 0!==d&&n(this.prototype,e,d)}}static getPropertyDescriptor(e,t,a){const{get:d,set:r}=c(this.prototype,e)??{get(){return this[t]},set(e){this[t]=e}};return{get:d,set(t){const i=d?.call(this);r?.call(this,t),this.requestUpdate(e,i,a)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??w}static _$Ei(){if(this.hasOwnProperty(v("elementProperties")))return;const e=f(this);e.finalize(),void 0!==e.l&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(v("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(v("properties"))){const e=this.properties,t=[...m(e),...p(e)];for(const a of t)this.createProperty(a,e[a])}const e=this[Symbol.metadata];if(null!==e){const t=litPropertyMetadata.get(e);if(void 0!==t)for(const[e,a]of t)this.elementProperties.set(e,a)}this._$Eh=new Map;for(const[e,t]of this.elementProperties){const a=this._$Eu(e,t);void 0!==a&&this._$Eh.set(a,e)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const a=new Set(e.flat(1/0).reverse());for(const e of a)t.unshift(s(e))}else void 0!==e&&t.push(s(e));return t}static _$Eu(e,t){const a=t.attribute;return!1===a?void 0:"string"==typeof a?a:"string"==typeof e?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),void 0!==this.renderRoot&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){const e=new Map,t=this.constructor.elementProperties;for(const a of t.keys())this.hasOwnProperty(a)&&(e.set(a,this[a]),delete this[a]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const a=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return((a,d)=>{if(t)a.adoptedStyleSheets=d.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet);else for(const t of d){const d=document.createElement("style"),r=e.litNonce;void 0!==r&&d.setAttribute("nonce",r),d.textContent=t.cssText,a.appendChild(d)}})(a,this.constructor.elementStyles),a}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,a){this._$AK(e,a)}_$ET(e,t){const a=this.constructor.elementProperties.get(e),d=this.constructor._$Eu(e,a);if(void 0!==d&&!0===a.reflect){const r=(void 0!==a.converter?.toAttribute?a.converter:x).toAttribute(t,a.type);this._$Em=e,null==r?this.removeAttribute(d):this.setAttribute(d,r),this._$Em=null}}_$AK(e,t){const a=this.constructor,d=a._$Eh.get(e);if(void 0!==d&&this._$Em!==d){const e=a.getPropertyOptions(d),r="function"==typeof e.converter?{fromAttribute:e.converter}:void 0!==e.converter?.fromAttribute?e.converter:x;this._$Em=d;const i=r.fromAttribute(t,e.type);this[d]=i??this._$Ej?.get(d)??i,this._$Em=null}}requestUpdate(e,t,a,d=!1,r){if(void 0!==e){const i=this.constructor;if(!1===d&&(r=this[e]),a??=i.getPropertyOptions(e),!((a.hasChanged??y)(r,t)||a.useDefault&&a.reflect&&r===this._$Ej?.get(e)&&!this.hasAttribute(i._$Eu(e,a))))return;this.C(e,t,a)}!1===this.isUpdatePending&&(this._$ES=this._$EP())}C(e,t,{useDefault:a,reflect:d,wrapped:r},i){a&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,i??t??this[e]),!0!==r||void 0!==i)||(this._$AL.has(e)||(this.hasUpdated||a||(t=void 0),this._$AL.set(e,t)),!0===d&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(e){Promise.reject(e)}const e=this.scheduleUpdate();return null!=e&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[e,t]of this._$Ep)this[e]=t;this._$Ep=void 0}const e=this.constructor.elementProperties;if(e.size>0)for(const[t,a]of e){const{wrapped:e}=a,d=this[t];!0!==e||this._$AL.has(t)||void 0===d||this.C(t,void 0,a,d)}}let e=!1;const t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(e=>e.hostUpdate?.()),this.update(t)):this._$EM()}catch(t){throw e=!1,this._$EM(),t}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(e=>e.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(e=>this._$ET(e,this[e])),this._$EM()}updated(e){}firstUpdated(e){}};k.elementStyles=[],k.shadowRootOptions={mode:"open"},k[v("elementProperties")]=new Map,k[v("finalized")]=new Map,b?.({ReactiveElement:k}),(h.reactiveElementVersions??=[]).push("2.1.2");const S=globalThis,z=e=>e,$=S.trustedTypes,C=$?$.createPolicy("lit-html",{createHTML:e=>e}):void 0,_="$lit$",A=`lit$${Math.random().toFixed(9).slice(2)}$`,T="?"+A,L=`<${T}>`,E=document,M=()=>E.createComment(""),I=e=>null===e||"object"!=typeof e&&"function"!=typeof e,P=Array.isArray,N="[ \t\n\f\r]",U=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,j=/-->/g,O=/>/g,R=RegExp(`>|${N}(?:([^\\s"'>=/]+)(${N}*=${N}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),D=/'/g,H=/"/g,B=/^(?:script|style|textarea|title)$/i,q=(e=>(t,...a)=>({_$litType$:e,strings:t,values:a}))(1),F=Symbol.for("lit-noChange"),G=Symbol.for("lit-nothing"),W=new WeakMap,V=E.createTreeWalker(E,129);function Y(e,t){if(!P(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==C?C.createHTML(t):t}const X=(e,t)=>{const a=e.length-1,d=[];let r,i=2===t?"<svg>":3===t?"<math>":"",o=U;for(let t=0;t<a;t++){const a=e[t];let s,l,n=-1,c=0;for(;c<a.length&&(o.lastIndex=c,l=o.exec(a),null!==l);)c=o.lastIndex,o===U?"!--"===l[1]?o=j:void 0!==l[1]?o=O:void 0!==l[2]?(B.test(l[2])&&(r=RegExp("</"+l[2],"g")),o=R):void 0!==l[3]&&(o=R):o===R?">"===l[0]?(o=r??U,n=-1):void 0===l[1]?n=-2:(n=o.lastIndex-l[2].length,s=l[1],o=void 0===l[3]?R:'"'===l[3]?H:D):o===H||o===D?o=R:o===j||o===O?o=U:(o=R,r=void 0);const m=o===R&&e[t+1].startsWith("/>")?" ":"";i+=o===U?a+L:n>=0?(d.push(s),a.slice(0,n)+_+a.slice(n)+A+m):a+A+(-2===n?t:m)}return[Y(e,i+(e[a]||"<?>")+(2===t?"</svg>":3===t?"</math>":"")),d]};class K{constructor({strings:e,_$litType$:t},a){let d;this.parts=[];let r=0,i=0;const o=e.length-1,s=this.parts,[l,n]=X(e,t);if(this.el=K.createElement(l,a),V.currentNode=this.el.content,2===t||3===t){const e=this.el.content.firstChild;e.replaceWith(...e.childNodes)}for(;null!==(d=V.nextNode())&&s.length<o;){if(1===d.nodeType){if(d.hasAttributes())for(const e of d.getAttributeNames())if(e.endsWith(_)){const t=n[i++],a=d.getAttribute(e).split(A),o=/([.?@])?(.*)/.exec(t);s.push({type:1,index:r,name:o[2],strings:a,ctor:"."===o[1]?te:"?"===o[1]?ae:"@"===o[1]?de:ee}),d.removeAttribute(e)}else e.startsWith(A)&&(s.push({type:6,index:r}),d.removeAttribute(e));if(B.test(d.tagName)){const e=d.textContent.split(A),t=e.length-1;if(t>0){d.textContent=$?$.emptyScript:"";for(let a=0;a<t;a++)d.append(e[a],M()),V.nextNode(),s.push({type:2,index:++r});d.append(e[t],M())}}}else if(8===d.nodeType)if(d.data===T)s.push({type:2,index:r});else{let e=-1;for(;-1!==(e=d.data.indexOf(A,e+1));)s.push({type:7,index:r}),e+=A.length-1}r++}}static createElement(e,t){const a=E.createElement("template");return a.innerHTML=e,a}}function J(e,t,a=e,d){if(t===F)return t;let r=void 0!==d?a._$Co?.[d]:a._$Cl;const i=I(t)?void 0:t._$litDirective$;return r?.constructor!==i&&(r?._$AO?.(!1),void 0===i?r=void 0:(r=new i(e),r._$AT(e,a,d)),void 0!==d?(a._$Co??=[])[d]=r:a._$Cl=r),void 0!==r&&(t=J(e,r._$AS(e,t.values),r,d)),t}class Z{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:a}=this._$AD,d=(e?.creationScope??E).importNode(t,!0);V.currentNode=d;let r=V.nextNode(),i=0,o=0,s=a[0];for(;void 0!==s;){if(i===s.index){let t;2===s.type?t=new Q(r,r.nextSibling,this,e):1===s.type?t=new s.ctor(r,s.name,s.strings,this,e):6===s.type&&(t=new re(r,this,e)),this._$AV.push(t),s=a[++o]}i!==s?.index&&(r=V.nextNode(),i++)}return V.currentNode=E,d}p(e){let t=0;for(const a of this._$AV)void 0!==a&&(void 0!==a.strings?(a._$AI(e,a,t),t+=a.strings.length-2):a._$AI(e[t])),t++}}class Q{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,a,d){this.type=2,this._$AH=G,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=a,this.options=d,this._$Cv=d?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===e?.nodeType&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=J(this,e,t),I(e)?e===G||null==e||""===e?(this._$AH!==G&&this._$AR(),this._$AH=G):e!==this._$AH&&e!==F&&this._(e):void 0!==e._$litType$?this.$(e):void 0!==e.nodeType?this.T(e):(e=>P(e)||"function"==typeof e?.[Symbol.iterator])(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==G&&I(this._$AH)?this._$AA.nextSibling.data=e:this.T(E.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:a}=e,d="number"==typeof a?this._$AC(e):(void 0===a.el&&(a.el=K.createElement(Y(a.h,a.h[0]),this.options)),a);if(this._$AH?._$AD===d)this._$AH.p(t);else{const e=new Z(d,this),a=e.u(this.options);e.p(t),this.T(a),this._$AH=e}}_$AC(e){let t=W.get(e.strings);return void 0===t&&W.set(e.strings,t=new K(e)),t}k(e){P(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let a,d=0;for(const r of e)d===t.length?t.push(a=new Q(this.O(M()),this.O(M()),this,this.options)):a=t[d],a._$AI(r),d++;d<t.length&&(this._$AR(a&&a._$AB.nextSibling,d),t.length=d)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){const t=z(e).nextSibling;z(e).remove(),e=t}}setConnected(e){void 0===this._$AM&&(this._$Cv=e,this._$AP?.(e))}}class ee{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,a,d,r){this.type=1,this._$AH=G,this._$AN=void 0,this.element=e,this.name=t,this._$AM=d,this.options=r,a.length>2||""!==a[0]||""!==a[1]?(this._$AH=Array(a.length-1).fill(new String),this.strings=a):this._$AH=G}_$AI(e,t=this,a,d){const r=this.strings;let i=!1;if(void 0===r)e=J(this,e,t,0),i=!I(e)||e!==this._$AH&&e!==F,i&&(this._$AH=e);else{const d=e;let o,s;for(e=r[0],o=0;o<r.length-1;o++)s=J(this,d[a+o],t,o),s===F&&(s=this._$AH[o]),i||=!I(s)||s!==this._$AH[o],s===G?e=G:e!==G&&(e+=(s??"")+r[o+1]),this._$AH[o]=s}i&&!d&&this.j(e)}j(e){e===G?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class te extends ee{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===G?void 0:e}}class ae extends ee{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==G)}}class de extends ee{constructor(e,t,a,d,r){super(e,t,a,d,r),this.type=5}_$AI(e,t=this){if((e=J(this,e,t,0)??G)===F)return;const a=this._$AH,d=e===G&&a!==G||e.capture!==a.capture||e.once!==a.once||e.passive!==a.passive,r=e!==G&&(a===G||d);d&&this.element.removeEventListener(this.name,this,a),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class re{constructor(e,t,a){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=a}get _$AU(){return this._$AM._$AU}_$AI(e){J(this,e)}}const ie=S.litHtmlPolyfillSupport;ie?.(K,Q),(S.litHtmlVersions??=[]).push("3.3.2");const oe=globalThis;let se=class extends k{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=((e,t,a)=>{const d=a?.renderBefore??t;let r=d._$litPart$;if(void 0===r){const e=a?.renderBefore??null;d._$litPart$=r=new Q(t.insertBefore(M(),e),e,void 0,a??{})}return r._$AI(e),r})(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return F}};se._$litElement$=!0,se.finalized=!0,oe.litElementHydrateSupport?.({LitElement:se});const le=oe.litElementPolyfillSupport;le?.({LitElement:se}),(oe.litElementVersions??=[]).push("4.2.2"),globalThis.SimpleColorsSharedStyles={},globalThis.SimpleColorsSharedStyles.instance=null;class ne extends se{static get styles(){return[o`
        html {
...
`,Re=[Se,ke,Se,...ze,$e,Ue,je,Ce,_e,Te,Le,Ee,Me,Ie,Ne,Pe,Ae,Oe];class De extends se{constructor(){super(),this.active=null,this.systems=[]}static get tag(){return"design-system"}static get properties(){return{active:{type:String},systems:{type:Object}}}updated(e){super.updated&&super.updated(e),e.forEach((e,t)=>{"active"===t&&this[t]&&this.systems[this.active]&&globalThis.document&&globalThis.document.head&&this.applyDesignSystem(e?this.systems[e]:null,this.systems[this.active])})}addDesignSystem(e){e.name&&e.styles&&e.fonts&&(this.systems[e.name]=e)}applyDesignSystem(e,t){if(e){try{globalThis.document.adoptedStyleSheets&&globalThis.document.adoptedStyleSheets.map((e,t)=>{e.ds&&globalThis.document.adoptedStyleSheets.splice(t,1)})}catch(e){const t=globalThis.document.createElement("style");t.innerHTML=globalStyles,globalThis.document.head.appendChild(t)}e.fonts&&globalThis.document.head.querySelectorAll("[data-ds]").forEach(e=>{e.remove()}),e.onload&&(globalThis.document.onload=null)}if(t){let e=t.styles.map(e=>e.cssText?e.cssText:"").join("");try{const a=new CSSStyleSheet;a.ds=!0,a.replaceSync(e),t.hax&&(a.hax=!0),globalThis.document.adoptedStyleSheets=[...globalThis.document.adoptedStyleSheets,a]}catch(t){const a=globalThis.document.createElement("style");a.innerHTML=e,globalThis.document.head.appendChild(a)}t.fonts&&t.fonts.forEach(e=>{const t=globalThis.document.createElement("link");t.setAttribute("href",e),t.setAttribute("rel","stylesheet"),t.setAttribute("fetchpriority","low"),t.setAttribute("data-ds","font"),globalThis.document.head.appendChild(t)}),t.onload&&(globalThis.document.onload=t.onload())}}}globalThis.customElements.define(De.tag,De),globalThis.DesignSystemManager=globalThis.DesignSystemManager||{},globalThis.DesignSystemManager.requestAvailability=()=>{if(!globalThis.DesignSystemManager.instance&&globalThis.document&&globalThis.document.body){let e=globalThis.document.createElement("design-system");globalThis.document.body.appendChild(e),globalThis.DesignSystemManager.instance=e}return globalThis.DesignSystemManager.instance};const He=globalThis.DesignSystemManager.requestAvailability(),Be=function(e){return class extends e{constructor(){super(),this.isSafari=void 0!==globalThis.safari,He.systems.ddd||(He.addDesignSystem({name:"ddd",styles:Re,fonts:we,onload:()=>{CSS.supports("initial-letter","1")||(console.warn("CSS feature: initial-letter not supported"),console.warn("Adding dropCap-noSupport class"),globalThis.document.body.classList.add("dropCap-noSupport"))},hax:!0}),He.active="ddd")}static get properties(){return{...super.properties,isSafari:{type:Boolean,reflect:!0,attribute:"is-safari"}}}static get styles(){let e=[];return super.styles&&(e=super.styles),[e,$e]}}};class qe extends(Be(me(se))){constructor(){super()}static get tag(){return"d-d-d"}}globalThis.customElements.define(qe.tag,qe);class Fe extends(Be(se)){constructor(){super(),this.type=null,this.option=0}static get styles(){return[super.styles,...ze,o`
        :host {
          display: flex;
      ...
      `]}updated(e){if(super.updated&&super.updated(e),e.has("type")&&this.shadowRoot){let e;e=["accent","primary","padding","margin","border-radius","box-shadow","border"].includes(this.type)?this.shadowRoot.querySelector("span.sample"):"font-size"===this.type?this.shadowRoot.querySelector("div.wrapper"):this.shadowRoot.querySelector("span.label");for(let t in be)e.removeAttribute(`data-${t}`);setTimeout(()=>{e.setAttribute(`data-${this.type}`,this.option)},0)}if(e.has("option")&&this.shadowRoot&&this.type){let e=this.shadowRoot.querySelector(`span[data-${this.type}]`);e&&e.setAttribute(`data-${this.type}`,this.option)}}render(){return q`
      <div class="wrapper">
        <span class="sample"></span
        ><span class="label"
          >${be[this.type][this.option]}<slot></slot
        ></span>
      </div>
    `}static get properties(){return{type:{type:String,reflect:!0},option:{type:String}}}static get tag(){return"d-d-d-sample"}}globalThis.customElements.define(Fe.tag,Fe),globalThis.I18NManagerStore=globalThis.I18NManagerStore||{},globalThis.I18NManagerStore.requestAvailability=()=>(!globalThis.I18NManagerStore.instance&&globalThis.document&&globalThis.document.body&&(globalThis.I18NManagerStore.instance=globalThis.document.createElement("i18n-manager"),globalThis.document.body.appendChild(globalThis.I18NManagerStore.instance)),globalThis.I18NManagerStore.instance);const Ge=globalThis.I18NManagerStore.requestAvailability();class We extends se{constructor(){super(),this.windowControllers=new AbortController,this.fetchTargets={},this.elements=[],this.locales=new Set([]),this.translationManifest=null,this.manifestLoaded=!1,this.manifestLoading=!1,this.lang=this.documentLang,this.dir=this.documentDir}get documentLang(){return globalThis.document.body.getAttribute("xml:lang")||globalThis.document.body.getAttribute("lang")||globalThis.document.documentElement.getAttribute("xml:lang")||globalThis.document.documentElement.getAttribute("lang")||globalThis.navigator.language||"en"}get documentDir(){return globalThis.document.body.getAttribute("xml:dir")||globalThis.document.body.getAttribute("dir")||globalThis.document.documentElement.getAttribute("xml:dir")||globalThis.document.documentElement.getAttribute("dir")||"ltr"}connectedCallback(){this.__ready=!0,globalThis.addEventListener("i18n-manager-register-element",this.registerLocalizationEvent.bind(this),{signal:this.windowControllers.signal}),globalThis.addEventListener("languagechange",this.changeLanguageEvent.bind(this),{signal:this.windowControllers.signal});try{this._docObserver=new MutationObserver(e=>{let t=null,a=null;e.forEach(e=>{if("attributes"===e.type){const d=e.attributeName;"lang"!==d&&"xml:lang"!==d||(t=this.documentLang),"dir"!==d&&"xml:dir"!==d||(a=this.documentDir)}}),t&&t!==this.lang&&(this.lang=t),a&&a!==this.dir&&(this.dir=a)});const e={attributes:!0,attributeFilter:["lang","xml:lang","dir","xml:dir"]};globalThis.document&&globalThis.document.documentElement&&this._docObserver.observe(globalThis.document.documentElement,e),globalThis.document&&globalThis.document.body&&this._docObserver.observe(globalThis.document.body,e)}catch(e){console.warn("i18n-manager: Failed to start document observer",e)}}disconnectedCallback(){if(this.windowControllers.abort(),this._docObserver){try{this._docObserver.disconnect()}catch(e){}this._docObserver=null}}changeLanguageEvent(e){const t=e&&e.detail?e.detail:this.documentLang;t&&(this.lang=t)}registerLocalizationEvent(e){let t=this.detailNormalize(e.detail);t.namespace&&t.localesPath&&this.registerLocalization(t)}detailNormalize(e){if(!e.namespace&&e.context&&(e.namespace=e.context.tagName.toLowerCase()),!e.updateCallback&&e.context&&(e.context.requestUpdate?e.updateCallback="requestUpdate":e.context.render&&(e.updateCallback="render")),!e.localesPath&&e.basePath&&(e.localesPath=`${decodeURIComponent(e.basePath)}/../locales`),e.context&&e.namespace){e.context.t&&(e.context._t={...e.context.t});let t=this.elements.filter(t=>{if(t.namespace==e.namespace&&t.localesPath)return!0});t&&t.length&&t[0]&&(e.localesPath=t[0].localesPath,t[0].locales&&(e.locales=t[0].locales))}return e}registerLocalization(e){(!e.context&&0===this.elements.filter(t=>t.namespace===e.namespace).length||0===this.elements.filter(t=>t.context===e.context).length)&&(e=this.detailNormalize(e),this.elements.push(e),e&&e.locales&&e.locales.forEach(this.locales.add,this.locales),this.lang&&this.__ready&&(e.locales&&e.locales.includes(this.lang)||!e.locales&&"en"!==this.lang&&!this.lang.startsWith("en-"))&&(clearTimeout(this._debounce),this._debounce=setTimeout(()=>{this.updateLanguage(this.lang)},0)))}async loadTranslationManifest(){if(this.manifestLoaded||this.manifestLoading)return this.translationManifest;this.manifestLoading=!0;try{const e=new URL("./lib/translation-manifest.json",import.meta.url).href,t=await fetch(e);if(t.ok){const e=await t.json();this.translationManifest=e.manifest||{},this.manifestLoaded=!0}else console.warn("Translation manifest not found, falling back to component locales"),this.translationManifest={},this.manifestLoaded=!0}catch(e){console.warn("Failed to load translation manifest:",e.message),this.translationManifest={},this.manifestLoaded=!0}finally{this.manifestLoading=!1}return this.translationManifest}hasTranslation(e,t){return!(!this.manifestLoaded||!this.translationManifest)&&(this.translationManifest[e]&&this.translationManifest[e].includes(t))}needsManifest(e){return e&&"en"!==e&&!e.startsWith("en-")}static get tag(){return"i18n-manager"}async loadNamespaceFile(e,t=this.lang){const a=t.split("-");let d=this.elements.filter(t=>t.namespace===e);if(d&&d.length>=1){const i=d[0];this.needsManifest(t)&&!this.manifestLoaded&&await this.loadTranslationManifest();const o=this.hasTranslation(e,t),s=this.hasTranslation(e,a[0]),l=i.locales&&i.locales.includes(t),n=i.locales&&i.locales.includes(a[0]),c=o||!this.manifestLoaded&&l,m=s||!this.manifestLoaded&&n,p=!i.locales,f=p&&(o||s||!this.manifestLoaded);if(!c&&!m&&!f)return{};var r="";return c||p&&o?r=`${i.localesPath}/${i.namespace}.${t}.json`:m||p&&s?r=`${i.localesPath}/${i.namespace}.${a[0]}.json`:p&&!this.manifestLoaded&&(r=`${i.localesPath}/${i.namespace}.${t}.json`),""==r?{}:(this.fetchTargets[r]||(this.fetchTargets[r]=await fetch(r).then(e=>!(!e||!e.json)&&e.json())),this.fetchTargets[r])}}async updateLanguage(e){if(e){const r=e.split("-");this.needsManifest(e)&&!this.manifestLoaded&&await this.loadTranslationManifest();const i=this.elements.filter(t=>{try{const a=this.hasTranslation(t.namespace,e),d=this.hasTranslation(t.namespace,r[0]),i=t.locales&&t.locales.includes(e),o=t.locales&&t.locales.includes(r[0]),s=!t.locales&&(this.manifestLoaded&&(a||d)||!this.manifestLoaded&&this.needsManifest(e));return a||d||i||o||s}catch(e){console.error("i18n registration incorrect in:",t,e)}}),o=this.elements.filter(t=>{try{const a=this.hasTranslation(t.namespace,e),d=this.hasTranslation(t.namespace,r[0]),i=t.locales&&t.locales.includes(e),o=t.locales&&t.locales.includes(r[0]),s=!t.locales&&(this.manifestLoaded&&(a||d)||!this.manifestLoaded&&this.needsManifest(e));return!(a||d||i||o||s)}catch(e){return!0}});if(0!==o.length)for(var t in o){let e=o[t];e.context&&(e.context.t={...e.context._t},e.updateCallback&&e.context[e.updateCallback]())}for(var t in i){let o=i[t];var a="";const s=this.hasTranslation(o.namespace,e),l=this.hasTranslation(o.namespace,r[0]),n=o.locales&&o.locales.includes(e),c=o.locales&&o.locales.includes(r[0]),m=!o.locales;if(s||n||m&&s?a=`${o.localesPath}/${o.namespace}.${e}.json`:l||c||m&&l?a=`${o.localesPath}/${o.namespace}.${r[0]}.json`:m&&!this.manifestLoaded&&(a=`${o.localesPath}/${o.namespace}.${e}.json`),a)if(this.fetchTargets[a]){if(o.context){let e=this.fetchTargets[a];for(var d in e)o.context.t[d]=e[d];o.context.t={...o.context.t},o.updateCallback&&o.context[o.updateCallback]()}}else if(this.fetchTargets[a]=await fetch(a).then(e=>!(!e||!e.json)&&e.json()),o.context){let e=this.fetchTargets[a];for(var d in e)o.context.t[d]=e[d];o.context.t={...o.context.t},o.updateCallback&&o.context&&o.context[o.updateCallback]()}}}}static get observedAttributes(){return["lang","dir"]}attributeChangedCallback(e,t,a){"lang"!==e&&"dir"!==e||this.dispatchEvent(new CustomEvent(`${e}-changed`,{detail:{value:a}})),"lang"===e&&a&&this.__ready&&this.updateLanguage(a)}get lang(){return this.getAttribute("lang")}set lang(e){e?this.setAttribute("lang",e):this.removeAttribute("lang")}get dir(){return this.getAttribute("dir")}set dir(e){e?this.setAttribute("dir",e):this.removeAttribute("dir")}}globalThis.customElements.define(We.tag,We);const Ve=function(e){return class extends e{constructor(){super(),this.t||(this.t={})}static get properties(){return{...super.properties,t:{type:Object}}}registerLocalization(e){!e.namespace&&e.context&&e.context.tagName&&e.context.tagName&&(e.namespace=e.context.tagName.toLowerCase()),e.updateCallback||(e.context.requestUpdate?e.updateCallback="requestUpdate":e.context.render&&(e.updateCallback="render")),!e.localesPath&&e.basePath&&(e.localesPath=`${decodeURIComponent(e.basePath)}/../locales`),Ge&&Ge.registerLocalization(e)}}},Ye=1;class Xe{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,a){this._$Ct=e,this._$AM=t,this._$Ci=a}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}const Ke=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends Xe{constructor(e){if(super(e),e.type!==Ye||"class"!==e.name||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){if(void 0===this.st){this.st=new Set,void 0!==e.strings&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(e=>""!==e)));for(const e in t)t[e]&&!this.nt?.has(e)&&this.st.add(e);return this.render(t)}const a=e.element.classList;for(const e of this.st)e in t||(a.remove(e),this.st.delete(e));for(const e in t){const d=!!t[e];d===this.st.has(e)||this.nt?.has(e)||(d?(a.add(e),this.st.add(e)):(a.remove(e),this.st.delete(e)))}return F}});class Je extends(Be(Ve(se))){static get tag(){return"instagram-play-list-arrow"}constructor(){super()}static get properties(){return{...super.properties}}static get styles(){return[super.styles,o`
      :host {
        display: flex;
    ...
    <div class="back-wrapper">
      <button class="back" @click=${()=>this.dispatchEvent(new CustomEvent("prev-clicked",{bubbles:!0,composed:!0}))}><</button>
    </div>
    <div class="next-wrapper">
      <button class="next" @click=${()=>this.dispatchEvent(new CustomEvent("next-clicked",{bubbles:!0,composed:!0}))}>></button>
    </div>
    `}}globalThis.customElements.define(Je.tag,Je);class Ze extends(Be(Ve(se))){static get tag(){return"instagram-play-list-slide"}constructor(){super(),this.active=!1}static get properties(){return{...super.properties,active:{type:Boolean,reflect:!0}}}static get styles(){return[super.styles,o`
      :host([active]) {
        display: block;
      }
      :host(:not([active])) {
    ...
    `]}render(){return q`
      ...
      `}}globalThis.customElements.define(et.tag,et);
